...
public class RequiredPortInstanceGroup extends WithResourceGroup<RequiredPortInstance> {

    public RequiredPortInstanceGroup() {
    }

    public RequiredPortInstanceGroup(Collection<RequiredPortInstance> content) {
        super(content);
    }
